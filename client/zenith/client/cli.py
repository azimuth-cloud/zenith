...
from .config import ConnectConfig, InitConfig
...
def init(config_path, **kwargs):
    ...
    An existing SSH identity can be provided, or one will be generated at the given
    path.
    """
...
@click.option(
    "--forward-to-port", type=int, help="The port to forward tunnel traffic to."
)
@click.option(
    "--debug", is_flag=True, default=None, help="Print extra information for debugging."
)
