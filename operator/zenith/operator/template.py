...
class Loader:
    ...
    def __init__(self, **globals):  # noqa: A002
        ...
        self.env.filters.update(
            mergeconcat=utils.mergeconcat, fromyaml=yaml.safe_load, toyaml=toyaml
        )
    ...
    def load(self, template, **params):
        """
        Render the specified template with the given params, load the result as a YAML
        document and return the resulting object.
        """
